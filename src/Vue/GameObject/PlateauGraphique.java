...
public class PlateauGraphique extends GameObject {
	...
	private float tailleRelative = 0.9f; // facteur de taille relative au cadre PlateauCadre(de 0 � 1)
	...
	/**
	 * XYtoCase : Permet de passer de coordonn�es (x,y) en pixel (de la souris par
	 * exemple) � une case du plateau graphique.
	 * 
	 * @param p
	 *            : un point
