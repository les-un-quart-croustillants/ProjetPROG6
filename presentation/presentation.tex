...
\begin{frame}{}
\begin{block}{Défaire/Refaire} %C'est l'undo-rados
Deux piles, l'historique des coups fait et l'historique des coups annulés. Une classe Move pour stocker un coup.
\end{block}
\begin{block}{Sauvegarde/Chargement}
\begin{itemize}
