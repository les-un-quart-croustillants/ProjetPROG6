...
\begin{block}{Composition du moteur}
\begin{itemize}
\item Automate a états fini détérministe
\item Données sur l'état courant
\item Fonctions publiques qui modifients l'état selon les règles du jeu
\end{itemize}
\end{block}
\end{frame}
